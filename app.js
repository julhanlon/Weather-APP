$(document).ready(function () {
  ...
  $.ajax({
    ...
    }&appid=4d1769f6552330211a2272f5cf6614ce&units=imperial`,
    dataType: "json",
  }).then(function (res) {
    console.log(res);
    ...
    // for (let index = 0; index < arr.length; index = index + 7) {
  ...
  $("#btnSubmit").on("click", function (e) {
    ...
    $.ajax({
      type: "GET",
      url: `https://api.openweathermap.org/data/2.5/forecast?q=${userInput}&appid=4d1769f6552330211a2272f5cf6614ce&units=imperial`,
      dataType: "json",
    }).then(function (res) {
      console.log(res);
      var today = moment().format("l");
